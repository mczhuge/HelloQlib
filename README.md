...
|------------------------------------------|-------------------------------------|-------------------|-------------------|-------------------|--------------|
| LSTM(Sepp Hochreiter, et al.)            | Alpha158(with selected 20 features) | 2min49s |  0.035872       | 0.553567       |  -0.118607 |
| Transformer(Ashish Vaswani, et al.)      | Alpha158                            | 9min27s | 0.061941       | 0.923842       | -0.097422 |
| Localformer(Juyong Jiang, et al.)        | Alpha158                            | 9min11s| 0.012461       | 0.201438       | -0.102535 |
| GATs (Petar Velickovic, et al.)          | Alpha158(with selected 20 features) | 11min52s | 0.057336       | 0.828178       | **-0.063197:triangular_flag_on_post:**|
| LightGBM(Guolin Ke, et al.)              | Alpha158                            | 14s | **0.091711:triangular_flag_on_post:**      | **1.034353:triangular_flag_on_post:**      | -0.103803 |
| Simplified Informer (modified from  Haoyi Zhou, et al.)  | Alpha158            | 4min39s |  **0.072150 :triangular_flag_on_post:**     | **1.081228:triangular_flag_on_post:**     | **-0.088342:triangular_flag_on_post:** |
